  ...
  return (
    <div style={{ paddingBottom: expanded ? "80vh" : "4rem" }}>
      <div className="flex justify-center pt-4 sm:pt-6 pb-4">
        <div className="relative w-full max-w-md px-3 sm:px-4">
          ...
          <div className="flex border-2 border-black bg-white overflow-hidden">
            <input
              ...
              className="flex-1 min-w-0 px-3 sm:px-4 py-2 text-sm bg-transparent outline-none placeholder:text-black/30"
              style={{ fontFamily: "'Courier New', Courier, monospace" }}
            />
            <button
              onClick={handleSearch}
              className="px-3 sm:px-4 py-2 bg-black text-white text-[10px] font-black tracking-[0.2em] uppercase hover:bg-gray-400 hover:text-black transition-colors duration-150 shrink-0"
              style={{ fontFamily: "'Courier New', Courier, monospace" }}
            >
              Search
            </button>
      ...
      <section
        className={`
          mt-6 sm:mt-10 fixed bottom-0 left-0 w-full overflow-hidden bg-white
      ...
      >
        ...
        {!loading && (
          <div
            ...
            `}
          >
            <div className="columns-1 sm:columns-3 lg:columns-4 xl:columns-5 gap-1">
              <div
              ...
              {hasMore && (
                <div className="col-span-full flex justify-center py-4">
                  <button
                    ...
                    className="border-2 border-black bg-black text-white px-6 sm:px-8 py-2 text-xs sm:text-sm font-black tracking-[0.2em] uppercase hover:bg-white hover:text-black transition-colors duration-150 disabled:opacity-50"
                    style={{ fontFamily: "'Courier New', Courier, monospace" }}
                  >
